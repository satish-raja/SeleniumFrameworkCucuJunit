...
public class PasswordResetStepDef {
    ...
    public void i_should_be_redirected_to_the_reset_password_page() {
        ...
        try {
            Assertions.assertTrue(loginPage.checkResetPasswordPageTitle(), "Reset Password page not found!");
    ...
    public void i_should_see_a_message(String expectedMessage) {
        ...
        try {
            Assertions.assertEquals("https://opensource-demo.orangehrmlive.com/web/index.php/auth/sendPasswordReset", currentUrl, "Navigated to wrong page");
            Assertions.assertTrue(loginPage.checkResetPasswordSuccessfullPageTitle(), "Reset Password page not found!");
        } catch (AssertionError e) {
