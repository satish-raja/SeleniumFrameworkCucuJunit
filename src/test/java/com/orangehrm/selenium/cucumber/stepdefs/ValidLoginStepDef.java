...
public class ValidLoginStepDef {
    ...
    public void i_should_be_logged_in_successfully() {
        ...
        try {
            Assertions.assertTrue(loginPage.isDashboardPageDisplayed(), "Dashboard page not displayed after login!");
    ...
    public void i_should_be_navigated_to_the_login_page() {
        ...
        try {
            Assertions.assertTrue(loginPage.checkLoginPageTitle(), "Login page not displayed after logout!");
        } catch (AssertionError e) {
